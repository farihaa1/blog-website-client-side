...
const AboutPage = () => {
  return (
    <motion.div
      ...
      className="container bg-base-content  mx-auto px-6 py-8 lg:py-16 my-16 flex flex-col gap-6 lg:px-24 text-base-300 "
    >
      ...
      <div className="flex flex-col md:flex-row-reverse justify-between gap-8 mb-12 w-full ">
        ...
        <div className="flex-1">
          <h3 className="text-xl md:text-2xl font-bold mb-4">
            Keep <span className="text-primary">Everyone</span> On the Same Page
          </h3>
          <ul className="list-disc pl-5 space-y-1 max-w-xl lg:text-lg">
            <li>
